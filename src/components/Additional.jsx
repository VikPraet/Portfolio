    ...
    items: [
      {
        ...
        content: [
          ...
          { type: 'image', src: '/Projects_Images/Mars_Base_Environment/beautyShot_2.jpg', size: 'large' },
          { type: 'image', src: '/Projects_Images/Mars_Base_Environment/beautyShot_2_detail_lighting.jpg', size: 'medium' },
          { type: 'image', src: '/Projects_Images/Mars_Base_Environment/beautyShot_2_lighting_only.jpg', size: 'medium' },
          
          { type: 'image', src: '/Projects_Images/Mars_Base_Environment/beautyShot_3.jpg', size: 'large' },
          { type: 'image', src: '/Projects_Images/Mars_Base_Environment/beautyShot_3_detail_lighting.jpg', size: 'medium' },
          { type: 'image', src: '/Projects_Images/Mars_Base_Environment/beautyShot_3_lighting_only.jpg', size: 'medium' },
          
          { type: 'image', src: '/Projects_Images/Mars_Base_Environment/beautyShot_4.jpg', size: 'large' },
          { type: 'image', src: '/Projects_Images/Mars_Base_Environment/beautyShot_4_detail_lighting.jpg', size: 'medium' },
          { type: 'image', src: '/Projects_Images/Mars_Base_Environment/beautyShot_4_lighting_only.jpg', size: 'medium' },  

          { type: 'image', src: '/Projects_Images/Mars_Base_Environment/My_Meshes.jpg', size: 'large' },
          { type: 'image', src: '/Projects_Images/Mars_Base_Environment/My_Textures.jpg', size: 'large' },  
        ],
      },
      {
        id: 2,
        ...
        image: '/Projects_Images/Diorama_by_the_Ocean/1GD12E_Praet_Vik_BeautyShot_00.png',
        featured: true,
        content: [
          { type: 'text', value: 'This diorama is inspired by a house in Miami, Florida, and modeled from scratch. You can explore the full 3D model here.' },
          { type: 'sketchfab', src: 'https://sketchfab.com/models/dff30c20efa14f29bf01899ebe45717a/embed?ui_theme=dark' },
          { type: 'image', src: '/Projects_Images/Diorama_by_the_Ocean/1GD12E_Praet_Vik_BeautyShot_00.png', size: 'large' },
          { type: 'image', src: '/Projects_Images/Diorama_by_the_Ocean/1GD12E_Praet_Vik_BeautyShot_01.png', size: 'large' },
          { type: 'image', src: '/Projects_Images/Diorama_by_the_Ocean/1GD12E_Praet_Vik_BeautyShot_02.png', size: 'large' },
        ],
      },
      {
        id: 2,
        ...
        image: '/Projects_Images/2D_Art/04_Characters.jpg',
        featured: true,
        content: [
          { type: 'text', value: 'A selection of various 2D graphics and game art pieces.' },
          { type: 'image', src: '/Projects_Images/2D_Art/01.Styleguide.png', size: 'large' },
          { type: 'image', src: '/Projects_Images/2D_Art/02.Assets.png', size: 'large' },
          { type: 'image', src: '/Projects_Images/2D_Art/03.ColourVariaton.png', size: 'medium' },
          { type: 'image', src: '/Projects_Images/2D_Art/04.Example_01.png', size: 'medium' },
          { type: 'image', src: '/Projects_Images/2D_Art/04.Example_02.png', size: 'medium' },
          { type: 'image', src: '/Projects_Images/2D_Art/04.Example_03.png', size: 'medium' },
          
          { type: 'video', src: 'https://www.youtube.com/embed/ZkCbpyv0iR8?si=NbzekaLs2qA1u5fA' },
          { type: 'image', src: '/Projects_Images/2D_Art/02_Styleguide.jpg', size: 'large' },
          { type: 'image', src: '/Projects_Images/2D_Art/04_Characters.jpg', size: 'large' },
          { type: 'image', src: '/Projects_Images/2D_Art/05_Startscreen.jpg', size: 'large' },
          { type: 'image', src: '/Projects_Images/2D_Art/06_Endscreen.jpg', size: 'large' },
        ],
      },
      {
        id: 2,
        ...
        image: '/Projects_Images/Procedural_Bridges/bridge_render.jpg',
        featured: true,
        content: [
          { type: 'text', value: 'This project showcases a tool I created in Houdini to generate bridges procedurally.' },
          { type: 'image', src: '/Projects_Images/Procedural_Bridges/bridge_render.jpg', size: 'large' },
