...
const softwareSkills = [
  {
    ...
    skills: [
      { name: 'Unreal Engine 5', familiarity: 'high' },
      { name: 'Unity 5', familiarity: 'high' },
    ],
    icon: (
  ...
  },
  {
    ...
    skills: [
      { name: 'GitHub', familiarity: 'high' },
      { name: 'Perforce', familiarity: 'high' },
    ],
    icon: (
  ...
  },
  {
    ...
    skills: [
      { name: 'GLM', familiarity: 'high' },
      { name: 'SDL', familiarity: 'high' },
      { name: 'Dear ImGui', familiarity: 'high' },
      { name: 'Vulkan', familiarity: 'medium' },
      { name: 'DirectX11', familiarity: 'medium' },
      { name: 'WPF', familiarity: 'medium' },
      { name: 'React', familiarity: 'medium' },
      { name: 'Tailwind CSS', familiarity: 'medium' },
    ],
    icon: (
      <svg className="w-8 h-8 mr-2 text-color-3" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 512" fill="currentColor">
  ...
  },
  {
    category: 'Tools',
    skills: [
      { name: 'Maya', familiarity: 'high' },
      { name: 'Photoshop', familiarity: 'high' },
      { name: 'Blender', familiarity: 'medium' },
      { name: 'Figma', familiarity: 'medium' },
      { name: 'RenderDoc', familiarity: 'medium' },
      { name: 'Houdini', familiarity: 'medium' },
      { name: 'Substance Painter', familiarity: 'medium' },
      { name: 'Premiere Pro', familiarity: 'medium' },
    ],
    icon: (
      <svg className="w-8 h-8 mr-2 text-color-3" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 512" fill="currentColor">
  ...
  },
  {
    category: 'IDEs',
    skills: [
      { name: 'Visual Studio', familiarity: 'high' },
      { name: 'Visual Studio Code', familiarity: 'high' },
      { name: 'JetBrains Rider', familiarity: 'high' },
      { name: 'Qt Creator', familiarity: 'high' },
    ],
    icon: (
      <svg className="w-8 h-8 mr-2 text-color-3" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 512" fill="currentColor">
...
const otherSkillsCategories = [
  ...
  },
  {
    ...
    skills: [
      { name: 'Dutch - Native', familiarity: 'high' },
      { name: 'English - Fluent', familiarity: 'high' },
    ],
  },
];
